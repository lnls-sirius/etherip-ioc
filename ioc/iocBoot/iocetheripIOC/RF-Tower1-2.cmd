...
set_pass0_restoreFile("RF-Tower1-2.sav")
set_pass1_restoreFile("RF-Tower1-2.sav")
...
dbLoadRecords("database/RF-Tower1-2.db", "PLC=plc2")
iocInit()

# Save things every 5 seconds
create_monitor_set("RF-Tower1-2.req", 5, "")
